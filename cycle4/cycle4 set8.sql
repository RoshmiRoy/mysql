...
#1
SELECT CUSTOMER.CID,CUSTOMER_NAME,BRANCH_NAME FROM BRANCH,CUSTOMER,DEPOSITOR,ACCOUNTS WHERE
 CUSTOMER.CID=DEPOSITOR.CID AND DEPOSITOR.ACCNO=ACCOUNTS.ACCNO AND ACCOUNTS.BID=1 
GROUP BY ACCOUNTS.BID HAVING COUNT(ACCOUNTS.BID)>=2;

#2
SELECT CUSTOMER.CID,CUSTOMER_NAME,ACCOUNTS.ACCNO,BRANCH_CITY FROM ACCOUNTS,BRANCH,DEPOSITOR,CUSTOMER WHERE
 BRANCH.BID=ACCOUNTS.BID AND ACCOUNTS.ACCNO=DEPOSITOR.ACCNO AND DEPOSITOR.CID=CUSTOMER.CID
...
WHERE CUSTOMER.CID=DEPOSITOR.CID AND DEPOSITOR.ACCNO=ACCOUNTS.ACCNO AND 
